      ...
      <div className="footer__inner">
        <div className="footer__top">
          <div className="footer__brand">
            <Link className="footer__logo" href="/" aria-label="OpenCreator home">
              OpenCreator<span aria-hidden="true">®</span>
            </Link>
            <p className="footer__tag">The commercial content agent.</p>
            <ul className="footer__socials" aria-label="Social links">
              <li>
                <Link href="https://discord.gg/rRKngTWjt6" target="_blank" rel="noopener noreferrer" aria-label="Discord">
              ...
              <li>
                <Link href="https://www.youtube.com/@OpenCreator-io" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                  <Youtube size={18} />
                </Link>
              </li>
              <li>
                <Link href="https://x.com/opencreator_io" target="_blank" rel="noopener noreferrer" aria-label="X / Twitter">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <li>
                <Link href="https://www.instagram.com/annieliu_opencreator/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                  <Instagram size={18} />
                </Link>
              </li>
            </ul>
          ...
          <nav className="footer__col" aria-label="Product">
            ...
            <ul>
              <li>
                <Link href="https://opencreator.super.site/" target="_blank" rel="noopener noreferrer">
                  {t('links.productWiki')}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="https://discord.gg/rRKngTWjt6" target="_blank" rel="noopener noreferrer">
                  {t('links.community')}
                </Link>
              </li>
              <li>
          ...
          <nav className="footer__col" aria-label="Solutions">
            ...
            <ul>
              <li>
                <Link href="/solutions/ecommerce-product-images">{t('solutionsLinks.ecommerceProductImages')}</Link>
              </li>
              <li>
          ...
          <nav className="footer__col" aria-label="Company">
            ...
            <ul>
              ...
              <li>
                <Link href="https://www.freeprivacypolicy.com/live/c04f0fc9-eb4d-443a-90dc-1cf893172a85" target="_blank" rel="noopener noreferrer">
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__lang">
            <button className="footer__lang-btn" type="button" aria-haspopup="listbox" aria-expanded="false">
          ...
          <p className="footer__wordmark" aria-hidden="true">OPENCREATOR</p>
        </div>
      </div>
    </footer>
  )
